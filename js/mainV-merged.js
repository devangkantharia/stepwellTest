    ...
    (function (sg) {
        ...
        (function (babylonjs) {
            ...
            (function (dk_1) {
                    ...
                    var AnimationUI = (function () {
                        function AnimationUI(dk) {
                            ...
                            animSkelChange.onclick = function (e) {
                                if (_this._dk.changeSkeleton(_this._animSkelList.selectedOptions[0].value))
                                    _this.update();
                                else
                            ...
                            animSkelClone.onclick = function (e) {
                                if (_this._dk.cloneChangeSkeleton(_this._animSkelList.selectedOptions[0].value))
                                    _this.update();
                                else
                            ...
                            animRangeMake.onclick = function (e) {
                                ...
                                _this._dk.createAnimRange(name, ars, are);
                            ...
                            document.getElementById("playAnim").onclick = function (e) {
                                ...
                                if (animName != null) {
                                    _this._dk.playAnimation(animName, rate, _this._animLoop.checked);
                                }
                                return true;
                            };
                            ...
                            document.getElementById("remAnim").onclick = function (e) {
                                if (_this._skel == null)
                                    return true;
                                var animName = _this._animSelect.value;
                                _this._dk.delAnimRange(animName, false);
                                _this._refreshAnimSelect();
                                return true;
                            };
                            document.getElementById("delAnim").onclick = function (e) {
                                if (_this._skel == null)
                                    return true;
                                var animName = _this._animSelect.value;
                                _this._dk.delAnimRange(animName, true);
                                _this._refreshAnimSelect();
                                return true;
                            };
                        }
                        ...
                        //            dos.closeText = "";
                        //            dos.close = (e, ui) => {
                        //                this.dk.switchDisabled = false;
                        //            };
                        //            this.meshAnimDiag.dialog(dos);
                        //        }
                        AnimationUI.prototype.update = function () {
                            //this.dk.switchDisabled = true;
                            this._skel = this._dk.getSkeleton();
                            var skelName;
                            if (this._skel == null) {
                        ...
                        AnimationUI.prototype._refreshAnimSelect = function () {
                            ...
                            var range = this._dk.getAnimationRanges();
                            if (range != null) {
                                var animOpt;
                        ...
                        AnimationUI.prototype._refreshAnimSkelList = function () {
                            ...
                            var skels = this._dk.getSkeltons();
                            var opt;
                ...
                })(gui = dk_1.gui || (dk_1.gui = {}));
            })(dk = babylonjs.dk || (babylonjs.dk = {}));
        })(babylonjs = sg.babylonjs || (sg.babylonjs = {}));
    })(sg = org.sg || (org.sg = {}));
})(org || (org = {}));
var org;
(function (org) {
            ...
            (function (dk_2) {
                ...
                (function (gui) {
                    ...
                    var EnvironmentUI = (function () {
                         ...
                         */
                        function EnvironmentUI(dk, addInternalAssetUI, dkGUI) {
                            var _this = this;
                            this._dk = dk;
                            this._dkGUI = dkGUI;
                            ...
                            var fog = $("#fog");
                            var fov = $("#fov");
                            sunPos.slider(this._sliderOptions(0, 180, this._dk.getSunPos()));
                            light.slider(this._sliderOptions(0, 100, 100 * this._dk.getLight()));
                            shade.slider(this._sliderOptions(0, 100, 100 * this._dk.getShade()));
                            fog.slider(this._sliderOptions(0, 100, 100 * this._dk.getFog()));
                            var fogColDiag = new gui.ColorPickerDiag("fog color", "fogCol", this._dk.getFogColor(), gui.DialogMgr.centerBottom, function (hex, hsv, rgb) {
                                _this._dk.setFogColor(hex);
                            });
                            fov.slider(this._sliderOptions(0, 180, this._dk.getFov()));
                            var envSnow = document.getElementById("envSnow");
                            envSnow.onclick = function (e) {
                                _this._dk.toggleSnow();
                            };
                            var envRain = document.getElementById("envRain");
                            envRain.onclick = function (e) {
                                //this.showAlertDiag("Sorry. To be implemented");
                                _this._dk.toggleRain();
                            };
                            ...
                            envSea.onclick = function (e) {
                                if (_this._dk.waterMesh == null || _this._dk.waterMesh.isDisposed()) {
                                    _this._dk.createWater();
                                }
                            };
                            var trnButton = document.getElementById("trnButton");
                            trnButton.onclick = function (e) {
                                //                if (this._groundUI2==null){
                                //                    this._groundUI2=new GroundUI2(this._dk,this._dkGUI);
                                //                }
                                //                this._groundUI2.toggle();
                                //                let r =this._dk.spreadOnGround();
                                //                if (r!=null){
                                //                    DialogMgr.showAlertDiag(r);
                                //                }
                                _this._dk.selectGround();
                                dkGUI.showPropDiag();
                                return true;
                            };
                            var ambColDiag = new gui.ColorPickerDiag("ambient color", "ambCol", this._dk.getAmbientColor(), gui.DialogMgr.centerBottom, function (hex, hsv, rgb) {
                                _this._dk.setAmbientColor(hex);
                            });
                            //            
                            //            let trnColDiag: ColorPickerDiag=new ColorPickerDiag("terrain color","trnCol",this._dk.getGroundColor(),DialogMgr.centerBottom,(hex,hsv,rgb) => {
                            //                this._dk.setGroundColor(hex);
                            //            });
                        ...
                        EnvironmentUI.prototype._handleSlide = function (e, ui) {
                            ...
                            if (slider === "fov") {
                                this._dk.setFov(ui.value);
                            }
                            else if (slider === "sunPos") {
                                this._dk.setSunPos(ui.value);
                            }
                            else {
                                var v = ui.value / 100;
                                if (slider === "light") {
                    ...
                    var GeneralUI = (function () {
                        function GeneralUI(dk, dkGUI) {
                            ...
                            this._genName.onchange = function () {
                                _this._dk.setName(_this._genName.value);
                            };
                            //space
                            this._genSpace = document.getElementById("genSpace");
                            this._genSpace.onchange = function () {
                                var err = _this._dk.setSpace(_this._genSpace.value);
                                if (err !== null) {
                                    gui.DialogMgr.showAlertDiag(err);
                                    _this._genSpace.value = _this._dk.getSpace();
                                }
                            };
                            //transforms
                            ...
                            this._genScale.onChange = function (v3) {
                                _this._dk.setScale(v3.x, v3.y, v3.z);
                                _this._genSize.setValue(_this._dk.getSize());
                            };
                            //Size
                            ...
                            this._genSnapTrans.onchange = function () {
                                var err = _this._dk.snapTrans(_this._genSnapTrans.checked);
                                if (err != null) {
                                    gui.DialogMgr.showAlertDiag(err);
                            ...
                            this._genSnapRot.onchange = function () {
                                var err = _this._dk.snapRot(_this._genSnapRot.checked);
                                if (err != null) {
                                    gui.DialogMgr.showAlertDiag(err);
                            ...
                            this._genSnapScale.onchange = function () {
                                var err = _this._dk.snapScale(_this._genSnapScale.checked);
                                if (err != null) {
                                    gui.DialogMgr.showAlertDiag(err);
                            ...
                            removeParent.onclick = function (e) {
                                var err = _this._dk.removeParent();
                                if (err != null) {
                                    gui.DialogMgr.showAlertDiag(err);
                                }
                                return false;
                            ...
                            removeChildren.onclick = function (e) {
                                var err = _this._dk.removeChildren();
                                if (err != null) {
                                    gui.DialogMgr.showAlertDiag(err);
                                }
                                return false;
                            ...
                            instMesh.onclick = function (e) {
                                var err = _this._dk.instance_mesh();
                                if (err != null) {
                                    gui.DialogMgr.showAlertDiag(err);
                                }
                                return false;
                            ...
                            subMesh.onclick = function (e) {
                                var err = _this._dk.csgOperation("subtract");
                                if (err != null) {
                                    gui.DialogMgr.showAlertDiag(err);
                                }
                                return false;
                            ...
                            interMesh.onclick = function (e) {
                                var err = _this._dk.csgOperation("intersect");
                                if (err != null) {
                                    gui.DialogMgr.showAlertDiag(err);
                                }
                                return false;
                            ...
                            downAsset.onclick = function (e) {
                                var downloadURL = _this._dk.saveAsset();
                                if (downloadURL == null) {
                            ...
                            swAv.onclick = function (e) {
                                var err = _this._dk.switchAvatar();
                                if (err != null) {
                                    gui.DialogMgr.showAlertDiag(err);
                                }
                                return true;
                            ...
                            swGnd.onclick = function (e) {
                                var err = _this._dk.switchGround();
                                if (err != null) {
                                    gui.DialogMgr.showAlertDiag(err);
                                }
                                return true;
                            ...
                            sNa.onclick = function (e) {
                                if (_this._snaUI == null) {
                                    _this._snaUI = new gui.SnaUI(_this._dk, _this._dkGUI);
                                }
                                _this._snaUI.show_sNaDiag();
                                return true;
                            };
                            //            addWater.onclick = (e) => {
                            //                var err: string = this.dk.addWater()
                            //                 if (err != null) {
                            ...
                            addParticles.onclick = function (e) {
                                if (_this._addInternalAssetUI == null) {
                                    _this._addInternalAssetUI = new gui.InternalAssetsUI(_this._dk);
                                }
                        ...
                        GeneralUI.prototype.update = function () {
                            this._genName.value = this._dk.getName();
                            this._genSpace.value = this._dk.getSpace();
                            this._updateTransform();
                            this._genDisable.checked = this._dk.isDisabled();
                            this._genColl.checked = this._dk.isCollideable();
                            this._genVisi.checked = this._dk.isVisible();
                        };
                        GeneralUI.prototype._updateTransform = function () {
                            this._genLoc.setValue(this._dk.getLocation());
                            this._genRot.setValue(this._dk.getRotation());
                            this._genScale.setValue(this._dk.getScale());
                            this._genSize.setValue(this._dk.getSize());
                        };
            ...
            (function (dk_4) {
                ...
                (function (gui) {
                    ...
                    var GrndDimUI = (function () {
                        function GrndDimUI(dk) {
                            var _this = this;
                            this._dk = dk;
                            var grnd = dk.ground;
                            this._grndID = new gui.VInputText("grndID", grnd.name);
                            this._grndHM = new gui.VFileInput("grndHM", null, "Height Map Image", gui.DialogMgr.centerBottom, dk_4.Dk.vF, "\.bmp$|\.png$|\.tga$\.jpg$", true);
                        ...
                        GrndDimUI.prototype.updateGround = function () {
                            ...
                            MeshBuilder.CreateGroundFromHeightMap(this._grndID.getValue(), this._grndHM.getValue(), {
                                ...
                                onReady: function (grnd) {
                                    ...
                                    Tags.AddTagsTo(grnd, "Dk.ground Dk.internal");
                                    grnd.receiveShadows = true;
                                    grnd.freezeWorldMatrix();
                                    _this._dk.ground = grnd;
                                    _this._dk.switchEditControl(grnd);
                        ...
                        GrndDimUI.prototype._adjustHts = function (grnd, grnd_old) {
                            //all meshes
                            var meshes = this._dk.scene.meshes;
                ...
                (function (gui) {
                    ...
                    var GrndSPSUI = (function () {
                        function GrndSPSUI(dk) {
                            ...
                            this._spsList = new gui.VInputSelect("spsList", this._dk.getGrndSPSList());
                        ...
                        GrndSPSUI.prototype._updateUI = function (gSPSid) {
                            ...
                            if (gSPSid) {
                                var gs = void 0;
                                gs = this._dk.getGrndSPSbyID(gSPSid);
                                if (gs == null) {
                        ...
                        GrndSPSUI.prototype._updateSpreadParms = function () {
                            ...
                            this._dk.updateSPSArray(this._grndSPS);
                            return true;
                        };
                        return GrndSPSUI;
                    }());
                    gui.GrndSPSUI = GrndSPSUI;
                })(gui = dk_5.gui || (dk_5.gui = {}));
            })(dk = babylonjs.dk || (babylonjs.dk = {}));
        })(babylonjs = sg.babylonjs || (sg.babylonjs = {}));
    })(sg = org.sg || (org.sg = {}));
})(org || (org = {}));
                ...
                (function (gui) {
                    ...
                    var GroundUI2 = (function () {
                        function GroundUI2(dk, dkGUI) {
                            ...
                            this._dkGUI.dialogs.push(this._grndDiag);
                        }
                        ...
                        GroundUI2.prototype.refreshPanel = function (panelIndex) {
                            if (panelIndex === 0 /* General */) {
                                if (this._generalUI == null)
                                    this._generalUI = new gui.GeneralUI(this._dk, this._dkGUI);
                                this._generalUI.update();
                            }
                            else if (panelIndex === 2 /* SPS */) {
                                if (this._SPSUI == null)
                                    this._SPSUI = new gui.LightUI(this._dk);
                                this._SPSUI.update();
                            }
                            else if (panelIndex === 1 /* Material */) {
                                if (this._materialUI == null)
                                    this._materialUI = new gui.MaterialUI(this._dk);
                ...
                (function (gui) {
                    ...
                    var InternalAssetsUI = (function () {
                        ...
                        InternalAssetsUI.prototype._createAssetDiag = function (assetType) {
                            ...
                            var items = this._getFiles(["internal", "assets", assetType], this._vF);
                        ...
                        InternalAssetsUI.prototype._updateAssetTable = function (tbl, assetType, items) {
                            ...
                            for (var _i = 0, items_1 = items; _i < items_1.length; _i++) {
                                ...
                                img.id = item["d"];
                                var name_1 = item["d"];
                                img.src = "dk/internal/assets/" + assetType + "/" + name_1 + "/" + name_1 + ".jpg";
                                img.setAttribute("style", gui.DkGUI.SMALL_ICON_SIZE + "cursor:pointer;");
                        ...
                        InternalAssetsUI.prototype._onAssetImgClick = function (e) {
                            ...
                            if (i.className === "skyboxes") {
                                this._dk.setSky(i.id);
                            }
                            else if (i.className === "primitives") {
                                this._dk.addPrim(i.id);
                            }
                            else if (i.className === "particles") {
                                //this._dk.createWater();
                                this._dk.createParticles(i.id);
                                console.log("particles clicked " + i.id);
                            }
                            else {
                                this._dk.loadAsset(i.className, i.id);
                            }
                            return true;
                        };
            ...
            (function (dk_8) {
                ...
                (function (gui) {
                    ...
                    var ItemListUI = (function () {
                        function ItemListUI(dk) {
                            var _this = this;
                            this._dk = dk;
                            this._updateTreeData();
                            this._itemsDiag = new gui.VTreeDialog(this._dk, "Items in Scene", gui.DialogMgr.leftCenter, this.treeData);
                            this._itemsDiag.addTreeListener(function (f, p, l) {
                                var i = f.indexOf(",");
                                f = f.substring(0, i);
                                _this._dk.selectMesh(f);
                            });
                        ...
                        ItemListUI.prototype._updateTreeData = function () {
                            ...
                            var items = this._dk.getMeshList();
            ...
            (function (dk_9) {
                ...
                (function (gui) {
                    ...
                    var ItemPropsUI = (function () {
                        function ItemPropsUI(dk, dkGUI) {
                            ...
                            this._propsVDiag.onClose(function () {
                                ...
                                if (!_this.refreshingPropsDiag) {
                                    ...
                                    if (_this._dk.isGroundPicked()) {
                                        _this._dk.unSelectGrnd();
                                    }
                                }
                            });
                        }
                        //        constructor_old(dk: Dk,dkGUI: DkGUI) {
                        //            this._dk=dk;
                        //            this._dkGUI=dkGUI;
                        //
                        //
                        ...
                        //                closeText: "",
                        //                close: () => {
                        //                    if(this._dkGUI.resizing) return;
                        ...
                        //                        }
                        //                        if(this._dk.isGroundPicked()) {
                        //                            this._dk.unSelectGrnd();
                        //                        }
                        //                    }
                        //                },
                        //                //after drag the dialog box doesnot resize
                        ...
                        //            this._dkGUI.dialogs.push(this._propsDiag);
                        //        }
                        ...
                        ItemPropsUI.prototype.refreshPanel = function (panelIndex) {
                            if (panelIndex === 0 /* General */) {
                                ...
                                if (this._grndSPSUI == null)
                                    this._grndSPSUI = new gui.GrndSPSUI(this._dk);
                                //this._grndSPSUI.update();
                            }
                            else if (panelIndex === 1 /* GrndDim */) {
                                if (this._grndDimUI == null)
                                    this._grndDimUI = new gui.GrndDimUI(this._dk);
                ...
                (function (gui) {
                    ...
                    var LightUI = (function () {
                        ...
                        LightUI.prototype.update = function () {
                            var lightParm = this._dk.getAttachedLight();
                            if (lightParm === null) {
                                this._lightAtt.checked = false;
                                lightParm = new dk_10.LightParm();
                            }
                            else {
                        ...
                        LightUI.prototype._applyLight = function () {
                            ...
                            if (!this._lightAtt.checked)
                                return;
                            var lightParm = new dk_10.LightParm();
                            ...
                            this._dk.attachAlight(lightParm);
                        };
                        return LightUI;
                    }());
                    gui.LightUI = LightUI;
                })(gui = dk_10.gui || (dk_10.gui = {}));
            })(dk = babylonjs.dk || (babylonjs.dk = {}));
        })(babylonjs = sg.babylonjs || (sg.babylonjs = {}));
    })(sg = org.sg || (org.sg = {}));
})(org || (org = {}));
                    ...
                    var MaterialUI = (function () {
                        function MaterialUI(dk) {
                            ...
                            this._matVis.oninput = function () {
                                ...
                                _this._dk.setMeshVisibility(parseFloat(_this._matVis.value));
                            };
                            //material details
                            ...
                            this._matBF.onchange = function () {
                                _this._dk.setMaterialBFC(_this._matIDs.value, _this._matBF.checked);
                            };
                            this._matClone = document.getElementById("matClone");
                            this._matClone.onclick = function () {
                                _this._dk.cloneMaterial(_this._matID.innerText);
                                _this.update();
                            };
                            this._matReplace = document.getElementById("matReplace");
                            this._matReplace.onclick = function () {
                                if (_this._materialListUI == null) {
                                    _this._materialListUI = new gui.MaterialListUI(_this._dk.scene, function (mat) {
                                        _this._dk.getMeshPicked().material = mat;
                                        _this.update();
                                    });
                                }
                            ...
                            this._matColType.onchange = function () {
                                var col = _this._dk.getMeshColor(_this._matID.innerText, _this._matColType.value);
                                _this._matColDiag.setColor(col);
                            };
                            this._matColDiag = new gui.ColorPickerDiag("mesh color", "matCol", this._dk.getMeshColor(this._matID.innerText, this._matColType.value), gui.DialogMgr.centerBottom, function (hex, hsv, rgb) {
                                var err = _this._dk.setMeshColor(_this._matID.innerText, _this._matColType.value, hex);
                                if (err !== null)
                                    gui.DialogMgr.showAlertDiag(err);
                            });
                            //material texture
                            ...
                            this._matTextType.onchange = function () {
                                var dtls = _this._dk.getMatTexture(_this._matID.innerText, _this._matTextType.value);
                                _this._textID = dtls[0];
                                _this._textName = dtls[1];
                                _this._matTextImg.src = _this._textName;
                                if (_this._textName.indexOf(".tga") >= 0) {
                                    _this._matTextImg.src = _this._dk.TGA_IMAGE;
                                }
                                else {
                                    _this._matTextImg.src = _this._textName;
                                }
                            ...
                            this._matTextImg.onclick = function () {
                                ...
                                if (_this._textureUI == null) {
                                    _this._textureUI = new gui.TextureUI(_this._dk);
                                }
                            ...
                            this._matCreateText.onclick = function () {
                                _this._matCreateText.setAttribute("style", "display:none");
                                _this._matRemText.setAttribute("style", "display:block");
                                _this._textID = _this._dk.createText();
                                _this._textName = "";
                                _this._dk.setMatTexture(_this._matID.innerText, _this._matTextType.value, _this._textID);
                                if (_this._textureUI == null) {
                                    _this._textureUI = new gui.TextureUI(_this._dk);
                                }
                                _this._textureUI.setParms(_this._textID, _this._textName, _this._matTextType.value, _this._matID.innerText, _this._matTextImg);
                            ...
                            this._matRemText.onclick = function () {
                                _this._matCreateText.setAttribute("style", "display:block");
                                _this._matRemText.setAttribute("style", "display:none");
                                _this._dk.removeMatTexture(_this._matID.innerText, _this._matTextType.value);
                                _this._textID = null;
                                _this._textName = _this._dk.NO_TEXTURE;
                                _this._matTextImg.src = _this._textName;
                            };
                            this.update();
                        }
                        MaterialUI.prototype.update = function () {
                            ...
                            this._matVis.value = Number(this._dk.getMeshVisibility()).toString();
                            this._matVisVal["value"] = Number(this._matVis.value).toFixed(2);
                            var mn = this._dk.getMatNames();
                            if (mn != null) {
                        ...
                        MaterialUI.prototype._updateMatDetails = function () {
                            ...
                            this._matName.innerText = this._dk.getMaterialName(this._matIDs.value);
                            this._matType.innerText = this._dk.getMaterialType(this._matIDs.value);
                            var b = this._dk.getMaterialBFC(this._matIDs.value);
                            if (typeof (b) == 'string') {
                                gui.DialogMgr.showAlertDiag(b);
                            }
                            else
                                this._matBF.checked = b;
                            this._matColDiag.setColor(this._dk.getMeshColor(this._matIDs.value, this._matColType.value));
                            var dtls = this._dk.getMatTexture(this._matID.innerText, this._matTextType.value);
                            this._textID = dtls[0];
                            this._textName = dtls[1];
                            this._matTextImg.src = this._textName;
                            if (this._textName.indexOf(".tga") >= 0) {
                                this._matTextImg.src = this._dk.TGA_IMAGE;
                            }
                            else {
                                this._matTextImg.src = this._textName;
                            }
                ...
                (function (gui) {
                    ...
                    var PhysicsUI = (function () {
                        ...
                        PhysicsUI.prototype.update = function () {
                            var phyParms = this._dk.getMeshPickedPhyParms();
                            if (phyParms !== null) {
                        ...
                        PhysicsUI.prototype._applyPhysics = function () {
                            ...
                            if (this._phyEna.checked) {
                                phyParms = new dk_12.PhysicsParm();
                            ...
                            this._dk.setMeshPickedPhyParms(phyParms);
                        };
            ...
            (function (dk_13) {
                ...
                (function (gui) {
                    ...
                    var SettingsUI = (function () {
                        //TODO pass property dialog instead of DkGUI
                        function SettingsUI(dk, dkGUI) {
                            var _this = this;
                            ...
                            dboSave.click = function (e) {
                                _this._dk.enableCameraCollision(_this._camCol.prop("checked"));
                                _this._dk.enableAutoEditMenu(_this._autoEditMenu.prop("checked"));
                                _this.enableToolTips = _this._showToolTips.prop("checked");
                                if (_this._showInvis.prop("checked")) {
                                    _this._dk.showAllInvisibles();
                                }
                                else {
                                    _this._dk.hideAllInvisibles();
                                }
                                if (_this._showDisa.prop("checked")) {
                                    _this._dk.showAllDisabled();
                                }
                                else {
                                    _this._dk.hideAllDisabled();
                                }
                                var err = _this._dk.snapper(_this._snapper.prop("checked"));
                                if (err != null) {
                                    gui.DialogMgr.showAlertDiag(err);
                                    return false;
                                }
                        ...
                        SettingsUI.prototype._updateSettings = function () {
                            this._camCol.prop("checked", this._dk.isCameraCollisionOn());
                            this._autoEditMenu.prop("checked", this._dk.isAutoEditMenuOn());
                ...
                (function (gui) {
                    ...
                    var SnaUI = (function () {
                        ...
                        SnaUI.prototype.create_sNaDiag = function () {
                            ...
                            this._dkGUI.dialogs.push(this.sNaDialog);
                            this.sensSel = document.getElementById("sensSel");
                            this.actSel = document.getElementById("actSel");
                            var sensors = this._dk.getSensorList();
                            var actuators = this._dk.getActuatorList();
                        ...
                        SnaUI.prototype.show_sNaDiag = function () {
                            var _this = this;
                            var sens = this._dk.getSensors();
                            if (sens == null) {
                                gui.DialogMgr.showAlertDiag("no mesh selected");
                                return;
                            }
                            var acts = this._dk.getActuators();
                            if (acts == null) {
                                gui.DialogMgr.showAlertDiag("no mesh selected");
                                return;
                            }
                            ...
                            addSens.onclick = function (e) {
                                ...
                                var sensor = s.value;
                                _this._dk.addSensorbyName(sensor);
                                _this.updateSensActTbl(_this._dk.getSensors(), _this.sensTbl);
                                _this.sNaDialog.dialog("close");
                                _this.sNaDialog.dialog("open");
                                return true;
                            };
                            ...
                            addAct.onclick = function (e) {
                                ...
                                _this._dk.addActuaorByName(actuator);
                                _this.updateSensActTbl(_this._dk.getActuators(), _this.actTbl);
                                _this.sNaDialog.dialog("close");
                                _this.sNaDialog.dialog("open");
                                return true;
                            };
                        ...
                        SnaUI.prototype.updateSensActTbl = function (sensAct, tbl) {
                            ...
                            for (var i = 0; i < l; i++) {
                                ...
                                delBut.onclick = function (e) {
                                    ...
                                    _this._dk.removeSensorActuator(el["sa"]);
                                    return true;
                                };
                            }
                        };
                        SnaUI.prototype.createEditSensDiag = function () {
                            ...
                            dos.closeOnEscape = false;
                            dos.open = function () {
                                _this._dk.disableKeys();
                            };
                            dos.close = function () {
                                _this._dk.enableKeys();
                            };
                        ...
                        SnaUI.prototype._createFileInput = function (fit) {
                            ...
                            fib.onclick = function (e) {
                                if (_this._sndAssetTDiag == null) {
                                    _this._sndAssetTDiag = new gui.VTreeDialog(_this._dk, fit.title, gui.DialogMgr.centerBottom, dk_14.Dk.vF, fit.filter, fit.openAll);
                                }
                ...
                (function (gui) {
                    ...
                    var TextureUI = (function () {
                        ...
                        TextureUI.prototype.update = function () {
                            this._matHScale.value = this._dk.getTextHScale(this._textID);
                            this._matVScale.value = this._dk.getTextVScale(this._textID);
                            this._matWRot.value = this._dk.getTextRot(this._textID);
                            this._matHO.value = this._dk.getTextHO(this._textID);
                            this._matVO.value = this._dk.getTextVO(this._textID);
                        };
                                ...
                                fiTD.addTreeListener(function (f, p, l) {
                                    if (l) {
                                        if (filter.indexOf(f.substring(f.length - 4)) >= 0) {
                                            fibL.textContent = p + f;
                                            //TODO set this value only if "save button clicked
                                            _this.value = "dk/" + fibL.textContent;
                                        }
                                    }
                                });
                                fiTD.toggle();
                ...
                (function (gui) {
                    var DkGUI = (function () {
                        function DkGUI(dk) {
                            ...
                            $("input").on("focus", function () { _this._dk.disableKeys(); });
                            $("input").on("blur", function () { _this._dk.enableKeys(); });
                            //main navigation menu 
                            // this.createNavMenu();
                            gui.DialogMgr.createAlertDiag();
                            window.addEventListener("resize", function (evt) { return _this.onWindowResize(evt); });
                        }
                        DkGUI.prototype.onWindowResize = function (evt) {
                        ...
                        /*DkGUI.prototype.createNavMenu = function () {
                            var _this = this;
                            ...
                            navAdd.onclick = function (e) {
                                if (_this._addAssetTDiag == null) {
                                    _this._addAssetTDiag = new gui.VTreeDialog(_this._dk, "Assets", gui.DialogMgr.leftCenter, dk_16.Dk.vF, "\.obj$|\.babylon$|\.glb$|\.gltf$", false);
                                    _this._addAssetTDiag.addTreeListener(function (f, p, l) {
                                        if (l) {
                                            if (f.indexOf(".obj") > 0 || f.indexOf(".babylon") > 0 || f.indexOf(".glb") > 0 || f.indexOf(".gltf") > 0) {
                                                _this._dk.loadAsset2(p, f);
                                            }
                                        }
                                    });
                                    _this._addAssetTDiag.addRefreshHandler(function () {
                                        $.getScript("dk/vF.js", function () {
                                            _this._addAssetTDiag.refresh(dk_16.Dk.vF);
                                        });
                                    });
                                }
                            ...
                            downWorld.onclick = function (e) {
                                var downloadURL = _this._dk.saveWorld();
                                if (downloadURL == null)
                                    return true;
                                if (_this._downloadDialog == null)
                                    _this._createDownloadDiag();
                            ...
                            navItems.onclick = function (e) {
                                if (_this._items == null) {
                                    _this._items = new gui.ItemListUI(_this._dk);
                                }
                                _this._items.toggle();
                                return false;
                            };
                            ...
                            navEnv.onclick = function (e) {
                                if (_this._environment == null) {
                                    ...
                                    _this._environment = new gui.EnvironmentUI(_this._dk, _this._addInternalAssetUI, _this);
                                }
                         ...
                         * is attached to mesh
                         */
                        DkGUI.prototype.showPropDiag = function () {
                            if (!this._dk.anyMeshSelected()) {
                                gui.DialogMgr.showAlertDiag("no mesh selected");
                                return;
                            }
                            if (this._itemProps == null) {
                                this._itemProps = new gui.ItemPropsUI(this._dk, this);
                            }
                         ...
                         */
                        DkGUI.prototype.handeEditControlClose = function () {
                            if (this._itemProps != null)
                        ...
                        DkGUI.LARGE_ICON_SIZE = "width:128px;height:128px;";
                        DkGUI.SMALL_ICON_SIZE = "width:64px;height:64px;";
                        return DkGUI;
                    }());
                    gui.DkGUI = DkGUI;
            ...
            (function (dk_17) {
                ...
                (function (gui) {
                    ...
                    var VTreeDialog = (function () {
                        function VTreeDialog(dk, diagTitle, pos, treeData, filter, openAll) {
                            var _this = this;
    ...
    (function (sg) {
        ...
        (function (babylonjs) {
            ...
            (function (dk_18) {
                var Vector2 = BABYLON.Vector2;
                var Vector3 = BABYLON.Vector3;
                var Random = org.sg.babylonjs.util.Random;
                ...
                var GroundSPS = (function () {
                    function GroundSPS(name, dk, mesh, groundMesh, spreadDtls) {
                        this.sx = 0;
                        this.sz = 0;
                        this.sCount = 0;
                        ...
                        this.sps = new SolidParticleSystem(name, this._dk.scene, { updatable: false, isPickable: false });
...
(function (org) {
    ...
    (function (sg) {
        ...
        (function (babylonjs) {
            var dk;
            (function (dk) {
                var EditControl = org.sg.babylonjs.component.EditControl;
                var CharacterController = org.sg.babylonjs.component.CharacterController;
                ...
                var GroundSPS = org.sg.babylonjs.dk.GroundSPS;
                ...
                var Vector3 = BABYLON.Vector3;
                var DkGUI = org.sg.babylonjs.dk.gui.DkGUI;
                var WaterMaterial = BABYLON.WaterMaterial;
                //import DkSerialized = org.sg.babylonjs.dk.DkSerialized;
                /**
                 * @author satguru
                 */
                var Dk = (function () {
                    function Dk(sceneFile, scenePath, editEnabled, canvasId) {
                        var _this = this;
                        this.actuator = "none";
                        ...
                        this.skyboxTextures = "dk/internal/textures/skybox-default/default";
                        //avatar stuff
                        this.avatarFolder = "dk/internal/avatar/";
                        ...
                        this.NO_TEXTURE = "dk/internal/textures/no-texture.jpg";
                        this.TGA_IMAGE = "dk/internal/textures/tga-image.jpg";
                        this.groundTexture = "dk/internal/textures/ground.jpg";
                        this.groundBumpTexture = "dk/internal/textures/ground-normal.jpg";
                        this.groundHeightMap = "dk/internal/textures/ground_heightMap.png";
                        this.terrainTexture = "dk/internal/textures/earth.jpg";
                        this.terrainHeightMap = "dk/internal/textures/worldHeightMap.jpg";
                        this.primTexture = "dk/internal/textures/Birch.jpg";
                        this.waterTexture = "dk/internal/textures/waterbump.png";
                        this.snowTexture = "dk/internal/textures/flare.png";
                        this.rainTexture = "dk/internal/textures/raindrop-1.png";
                        this.snowPart = null;
                        this.snowing = false;
                        this.rainPart = null;
                        this.raining = false;
                        this.SOUND_ASSET_LOCATION = "dk/assets/sounds/";
                    ...
                    Dk.prototype.loadSceneFile = function (scenePath, sceneFile, scene) {
                        var _this = this;
                    ...
                    Dk.prototype.getGuiSettings = function () {
                        if (this.dkSerialized !== null)
                            return this.dkSerialized.guiSettings;
                        else
                            return null;
                    };
                    Dk.prototype.onTaskSuccess = function (obj) {
                        var _this = this;
                        var tfat = obj;
                        var foo = JSON.parse(tfat.text);
                        this.dkSerialized = foo["DkSerialized"];
                        //this.snas = <SNAserialized[]>foo["DkSNA"];
                        this.snas = this.dkSerialized.snas;
                        this._cameraCollision = this.dkSerialized.settings.cameraCollision;
                        this.autoEditMenu = this.dkSerialized.settings.autoEditMenu;
                    ...
                    Dk.prototype.onTaskFailure = function (obj) {
                        alert("scene load failed");
                    };
                    Dk.prototype.setShadowProperty = function (sl, shadowGenerator) {
                    ...
                    Dk.prototype.onSceneLoaded = function (scene) {
                        var _this = this;
                        ...
                        for (var _i = 0, _a = scene.meshes; _i < _a.length; _i++) {
                            ...
                            if (Tags.HasTags(mesh)) {
                                if (Tags.MatchesQuery(mesh, "Dk.avatar")) {
                                    avFound = true;
                                    this.avatar = mesh;
                                ...
                                else if (Tags.MatchesQuery(mesh, "Dk.sky")) {
                                    skyFound = true;
                                    this.skybox = mesh;
                                    this.skybox.isPickable = false;
                                }
                                else if (Tags.MatchesQuery(mesh, "Dk.ground")) {
                                    groundFound = true;
                                    this.ground = mesh;
                                }
                            }
                        ...
                        for (var _b = 0, _c = scene.skeletons; _b < _c.length; _b++) {
                            var skeleton = _c[_b];
                            if (Tags.MatchesQuery(skeleton, "Dk.skeleton") || (skeleton.name === "Dk.skeleton")) {
                                skelFound = true;
                        ...
                        for (var _d = 0, _e = scene.lights; _d < _e.length; _d++) {
                            var light = _e[_d];
                            if (Tags.MatchesQuery(light, "Dk.sun")) {
                                sunFound = true;
                                this.sun = light;
                            }
                        }
                        if (!sunFound) {
                            console.log("no dk sun found. creating sun");
                            //this.sun = new HemisphericLight("Dk.hl01", new Vector3(0, 1, 0), this.scene);
                            this.sun = new HemisphericLight("Dk.hl01", new Vector3(1, 1, 0), this.scene);
                            this.sun.groundColor = new Color3(0.5, 0.5, 0.5);
                            Tags.AddTagsTo(this.sun, "Dk.sun");
                            this.sunDR = new DirectionalLight("Dk.dl01", new Vector3(-1, -1, 0), this.scene);
                        ...
                        for (var _k = 0, _l = scene.cameras; _k < _l.length; _k++) {
                            var camera = _l[_k];
                            if (Tags.MatchesQuery(camera, "Dk.camera")) {
                                cameraFound = true;
                                this.mainCamera = camera;
                                this.setCameraSettings(this.mainCamera);
                                this.mainCamera.attachControl(this.canvas, true);
                                //this.mainCamera.target = this.dkSerialized.misc.activeCameraTarget;
                            }
                        }
                        if (!cameraFound) {
                            console.log("no dk camera found. creating camera");
                        ...
                        if (!groundFound) {
                            console.log("no dk ground found. creating ground");
                            ...
                            //                }
                            if (this.dkSerialized.groundSPSserializeds != null) {
                                this.GroundSPSs = new Array();
                                for (var _m = 0, _o = this.dkSerialized.groundSPSserializeds; _m < _o.length; _m++) {
                                    var gSPSs = _o[_m];
                        ...
                        if (!skyFound) {
                            console.log("no dk sky found. creating sky");
                        ...
                        if (!avFound) {
                            console.log("no dk av found. creating av");
                        ...
                        dk.SNAManager.getSNAManager().unMarshal(this.snas, this.scene);
                        this.snas = null;
                        this.render();
                    };
                    ...
                    Dk.prototype.startRenderLoop = function () {
                        var _this = this;
                        //this.backfaceCulling(this.scene.materials);
                        if (this.editEnabled) {
                            this.dkGUI = new DkGUI(this);
                        }
                        else {
                            this.dkGUI = null;
                        }
                    ...
                    Dk.prototype.resetKeys = function () {
                        this.key.focus = false;
                        this.key.esc = false;
                        this.key.trans = false;
                        this.key.rot = false;
                    ...
                    Dk.prototype.getMeshPicked = function () {
                        return this.meshPicked;
                    };
                    Dk.prototype.pickObject = function (evt, pickResult) {
                    ...
                    Dk.prototype.selectForEdit = function (mesh) {
                        var _this = this;
                        //if in multiselect then remove from multiselect
                        this.multiUnSelect(mesh);
                        this.isMeshSelected = true;
                        this.meshPicked = mesh;
                        dk.SNAManager.getSNAManager().disableSnAs(this.meshPicked);
                        this.savePhyParms();
                     ...
                     * @param mesh
                     */
                    Dk.prototype.switchEditControl = function (mesh) {
                        if (this.switchDisabled)
                            return;
                        dk.SNAManager.getSNAManager().enableSnAs(this.meshPicked);
                        ...
                        this.dkGUI.refreshPropsDiag();
                    };
                    /**
                     * if not set then set the mesh rotation in qauternion
                     */
                    Dk.prototype.switchToQuats = function (m) {
                    ...
                    Dk.prototype.highLight = function (am) {
                    ...
                    Dk.prototype.unHighLight = function (am) {
                        //            am.renderOutline=false;
                        //            am.showBoundingBox=false;
                        am.disableEdgesRendering();
                    };
                    Dk.prototype.multiSelect = function (currentMesh) {
                    ...
                    Dk.prototype.multiUnSelect = function (mesh) {
                        if (this.meshesPicked == null)
                            return false;
                    ...
                    Dk.prototype.multiUnSelectAll = function () {
                        if (this.meshesPicked === null)
                            return;
                    ...
                    Dk.prototype.removeEditControl = function () {
                        this.multiUnSelectAll();
                        this.isMeshSelected = false;
                        //            if (!this.focusOnAv) {
                        //                this.switchFocusToAV();
                        ...
                        //if(this.autoEditMenu) this.dkGUI.closePropDiag();
                        //close properties dialog if open
                        this.dkGUI.handeEditControlClose();
                        if (this.meshPicked != null) {
                            dk.SNAManager.getSNAManager().enableSnAs(this.meshPicked);
                            this.restorePhyParms();
                        }
                    };
                    Dk.prototype.switchFocusToAV = function () {
                    ...
                    Dk.prototype.focusOnMesh = function (mesh, frames) {
                        this.mainCamera.detachControl(this.canvas);
                        this.frames = frames;
                        this.f = frames;
                    ...
                    Dk.prototype.animateCamera = function () {
                        var avTarget = new Vector3(this.avatar.position.x, (this.avatar.position.y + 1.5), this.avatar.position.z);
                    ...
                    Dk.prototype.justReFocus = function () {
                        this.mainCamera.setTarget(this.mainCamera.target.add(this.delta2));
                        this.f--;
                        if (this.f < 0) {
                            this.cameraAnimating = false;
                    ...
                    Dk.prototype.onWindowResize = function (event) {
                        this.engine.resize();
                    };
                    Dk.prototype.onKeyDown = function (e) {
                        var event = e;
                        if (event.keyCode === 16)
                            this.key.shift = true;
                        if (event.keyCode === 17)
                    ...
                    Dk.prototype.onKeyUp = function (e) {
                        var event = e;
                        if (event.keyCode === 16)
                    ...
                    Dk.prototype.createPrimMaterial = function () {
                    ...
                    Dk.prototype.createPrimPBRMaterial = function () {
                    ...
                    Dk.prototype.setPrimProperties = function (mesh) {
                        ...
                        //sat TODO remove comment
                        //mesh.receiveShadows = true;
                        Tags.AddTagsTo(mesh, "Dk.prim Dk.internal");
                    ...
                    Dk.prototype.addPrim = function (primType) {
                        var mesh = null;
                        if (primType === "plane")
                            mesh = this.addPlane();
                    ...
                    Dk.prototype.toggleCollision = function () {
                        if (!this.isMeshSelected) {
                            return "no mesh selected";
                        }
                        this.meshPicked.checkCollisions = !this.meshPicked.checkCollisions;
                    };
                    Dk.prototype.enableCollision = function (yes) {
                        this.meshPicked.checkCollisions = yes;
                    };
                    Dk.prototype.isCollideable = function () {
                        return this.meshPicked.checkCollisions;
                    };
                    Dk.prototype.toggleEnable = function () {
                        if (!this.isMeshSelected) {
                            return "no mesh selected";
                        }
                        this.meshPicked.setEnabled(!this.meshPicked.isEnabled());
                    };
                    Dk.prototype.disableIt = function (yes) {
                        this.meshPicked.setEnabled(!yes);
                    };
                    Dk.prototype.isDisabled = function () {
                        return !this.meshPicked.isEnabled();
                    };
                    Dk.prototype.showAllDisabled = function () {
                    ...
                    Dk.prototype.hideAllDisabled = function () {
                        for (var _i = 0, _a = this.scene.meshes; _i < _a.length; _i++) {
                            var mesh = _a[_i];
                            if (!mesh.isEnabled()) {
                                this.unHighLight(mesh);
                    ...
                    Dk.prototype.makeVisibile = function (yes) {
                        if (!this.isMeshSelected) {
                            return "no mesh selected";
                        }
                    ...
                    Dk.prototype.isVisible = function () {
                    ...
                    Dk.prototype.showAllInvisibles = function () {
                    ...
                    Dk.prototype.hideAllInvisibles = function () {
                        this.showingAllInvisibles = false;
                        for (var i = 0; i < this.scene.meshes.length; i++) {
                            for (var i = 0; i < this.scene.meshes.length; i++) {
                                var mesh = this.scene.meshes[i];
                    ...
                    Dk.prototype.makeParent = function () {
                        if (!this.isMeshSelected) {
                            return "no mesh selected";
                        }
                    ...
                    Dk.prototype.removeParent = function () {
                        if (!this.isMeshSelected) {
                            return "no mesh selected";
                        }
                    ...
                    Dk.prototype.removeChildren = function () {
                        if (!this.isMeshSelected) {
                            return "no mesh selected";
                        }
                        var mesh = this.meshPicked;
                    ...
                    Dk.prototype.clone_mesh = function () {
                        if (!this.isMeshSelected) {
                            return "no mesh selected";
                        }
                        //            if((this.meshPicked!=null&&this.meshPicked instanceof BABYLON.InstancedMesh)) {
                    ...
                    Dk.prototype.clonetheMesh = function (mesh) {
                        var name = new Number(Date.now()).toString();
                    ...
                    Dk.prototype.animateMesh = function (mesh) {
                    ...
                    Dk.prototype.delete_mesh = function () {
                        if (!this.isMeshSelected) {
                            return "no mesh selected";
                        }
                        if (this.meshesPicked != null) {
                    ...
                    Dk.prototype.deleteTheMesh = function (mesh) {
                        dk.SNAManager.getSNAManager().removeSNAs(mesh);
                    ...
                    Dk.prototype.mergeMeshes_old = function () {
                        if (this.meshesPicked != null) {
                            for (var _i = 0, _a = this.meshesPicked; _i < _a.length; _i++) {
                                var mesh = _a[_i];
                    ...
                    Dk.prototype.mergeMeshes = function () {
                        if (this.meshesPicked != null) {
                            for (var _i = 0, _a = this.meshesPicked; _i < _a.length; _i++) {
                                var mesh = _a[_i];
                                if (mesh instanceof BABYLON.InstancedMesh) {
                    ...
                    Dk.prototype.csgOperation = function (op) {
                        if (this.meshesPicked != null) {
                    ...
                    Dk.prototype.physTypes = function () {
                    ...
                    Dk.prototype.getMeshPickedPhyParms = function () {
                        return this.meshPickedPhyParms;
                    };
                    Dk.prototype.setMeshPickedPhyParms = function (parms) {
                    ...
                    Dk.prototype.savePhyParms = function () {
                    ...
                    Dk.prototype.restorePhyParms = function () {
                    ...
                    Dk.prototype.testPhysics = function (phyParm) {
                        this.resetPhysics();
                    ...
                    Dk.prototype.resetPhysics = function () {
                        if (this.didPhysTest) {
                            this.didPhysTest = false;
                    ...
                    //MATERIAL
                    Dk.prototype.setMeshVisibility = function (vis) {
                        this.meshPicked.visibility = vis;
                    };
                    Dk.prototype.getMeshVisibility = function () {
                        return this.meshPicked.visibility;
                    };
                    Dk.prototype.setMeshColor = function (matId, colType, hex) {
                    ...
                    Dk.prototype.getMatNames = function () {
                        var mn = new Array();
                        if (this.isMeshSelected) {
                    ...
                    Dk.prototype.getMaterialName = function (id) {
                    ...
                    Dk.prototype.getMaterialType = function (id) {
                        var mat = this.scene.getMaterialByID(id);
                        if (mat == null)
                            return null;
                    ...
                    //back face culling
                    Dk.prototype.setMaterialBFC = function (id, b) {
                        var mat = this.scene.getMaterialByID(id);
                        if (mat == null)
                            return null;
                    ...
                    //back face culling
                    Dk.prototype.getMaterialBFC = function (id) {
                        var mat = this.scene.getMaterialByID(id);
                        if (mat == null)
                            return "material not found";
                        return mat.backFaceCulling;
                    };
                    Dk.prototype.cloneMaterial = function (id) {
                        var mat = this.scene.getMaterialByID(id);
                        if (mat == null)
                            return null;
                        if (this.meshPicked.material instanceof BABYLON.MultiMaterial) {
                    ...
                    Dk.prototype.createText = function () {
                     ...
                     */
                    Dk.prototype.getMatTexture = function (matId, type) {
                        var sm = this.scene.getMaterialByID(matId);
                        if (sm == null)
                            return null;
                        var uid = null;
                    ...
                    Dk.prototype.setMatTexture = function (matId, type, textID) {
                    ...
                    Dk.prototype.removeMatTexture = function (matId, type) {
                        var sm = this.scene.getMaterialByID(matId);
                        if (sm == null)
                            return;
                        if (type == "diffuse") {
                    ...
                    Dk.prototype.setTextURL = function (textID, textName) {
                        var bt = this.getTextureByID(textID);
                        bt.name = textName;
                        bt.updateURL(textName);
                    };
                    Dk.prototype.setTextHScale = function (textID, scale) {
                        var text = this.getTextureByID(textID);
                        text.uScale = scale;
                    };
                    Dk.prototype.getTextHScale = function (textID) {
                        var text = this.getTextureByID(textID);
                        return Number(text.uScale).toString();
                    };
                    Dk.prototype.setTextVScale = function (textID, scale) {
                        var text = this.getTextureByID(textID);
                        text.vScale = scale;
                    };
                    Dk.prototype.getTextVScale = function (textID) {
                        var text = this.getTextureByID(textID);
                        return Number(text.vScale).toString();
                    };
                    Dk.prototype.setTextHO = function (textID, o) {
                        var text = this.getTextureByID(textID);
                        text.uOffset = o;
                    };
                    Dk.prototype.getTextHO = function (textID) {
                        var text = this.getTextureByID(textID);
                        return Number(text.uOffset).toString();
                    };
                    Dk.prototype.setTextVO = function (textID, o) {
                        var text = this.getTextureByID(textID);
                        text.vOffset = o;
                    };
                    Dk.prototype.getTextVO = function (textID) {
                        var text = this.getTextureByID(textID);
                        return Number(text.vOffset).toString();
                    };
                    Dk.prototype.setTextRot = function (textID, rot, type) {
                        var text = this.getTextureByID(textID);
                        rot = rot * Math.PI / 180;
                        if (type == "u") {
                            text.uAng = rot;
                    ...
                    Dk.prototype.getTextRot = function (textID) {
                        var text = this.getTextureByID(textID);
                        return Number(text.wAng * 180 / Math.PI).toString();
                    };
                    Dk.prototype.getTextures = function () {
                    ...
                    Dk.prototype.getTextureByName = function (name) {
                        var ts = this.scene.textures;
                    ...
                    Dk.prototype.getTextureByID = function (id) {
                        var ts = this.scene.textures;
                    ...
                    Dk.prototype.getMeshColor = function (matId, colType) {
                        var sm = this.scene.getMaterialByID(matId);
                        if (sm == null)
                            return null;
                    ...
                    Dk.prototype.getMeshList = function () {
                    ...
                    Dk.prototype.selectMesh = function (meshId) {
                    ...
                    Dk.prototype.selectGround = function () {
                        if (!this.isMeshSelected) {
                    ...
                    Dk.prototype.unSelectGrnd = function () {
                        this.removeEditControl();
                    };
                    //
                    // LIGHTS
                     ...
                     * else return null
                     */
                    Dk.prototype.getAttachedLight = function () {
                    ...
                    Dk.prototype.attachAlight = function (lightParm) {
                        this.detachLight();
                        var light = null;
                    ...
                    Dk.prototype.detachLight = function () {
                        var childs = this.meshPicked.getDescendants();
                        if (childs.length === 0)
                            return;
                        var light = null;
                    ...
                    Dk.prototype.setTransOn = function () {
                        //if scaling is on then we might have changed space to local            
                        //restore space to what is was before scaling
                        //            if (this.editControl.isScalingEnabled()) {
                        //                this.setSpaceLocal(this.wasSpaceLocal);
                    ...
                    Dk.prototype.isTransOn = function () {
                        return this.editControl.isTranslationEnabled();
                    };
                    Dk.prototype.setRotOn = function () {
                        //if scaling is on then we might have changed space to local            
                        //restore space to what is was before scaling
                        //            if (this.editControl.isScalingEnabled()) {
                        //                this.setSpaceLocal(this.wasSpaceLocal);
                    ...
                    Dk.prototype.isScaleOn = function () {
                        return this.editControl.isScalingEnabled();
                    };
                    Dk.prototype.setFocusOnMesh = function () {
                        if (this.isFocusOnAv) {
                            this.cc.stop();
                     ...
                     */
                    Dk.prototype.setFocusOnNothing = function () {
                        if (this.isFocusOnAv) {
                            this.cc.stop();
                            this.saveAVcameraPos.copyFrom(this.mainCamera.position);
                            this.isFocusOnAv = false;
                    ...
                    Dk.prototype.setSpace = function (space) {
                    ...
                    Dk.prototype.getSpace = function () {
                        if (this.isSpaceLocal())
                            return "local";
                        else
                            return "world";
                    };
                    Dk.prototype.setSpaceLocal = function (yes) {
                        if ((this.editControl != null) && (!this.editControl.isScalingEnabled()))
                            this.editControl.setLocal(yes);
                        this.spaceWorld = !yes;
                        return null;
                    };
                    Dk.prototype.isSpaceLocal = function () {
                    ...
                    Dk.prototype.snapTrans = function (yes) {
                        if (this.snapperOn) {
                    ...
                    Dk.prototype.isSnapTransOn = function () {
                        return this.snapTransOn;
                    };
                    Dk.prototype.setSnapTransValue = function (val) {
                        if (isNaN(val))
                            return;
                        this.editControl.setTransSnapValue(val);
                    };
                    Dk.prototype.snapRot = function (yes) {
                        if (this.snapperOn) {
                            return "Cannot change snapping mode when snapper is on";
                        }
                        this.snapRotOn = yes;
                    ...
                    Dk.prototype.isSnapRotOn = function () {
                        return this.snapRotOn;
                    };
                    Dk.prototype.setSnapRotValue = function (val) {
                        if (isNaN(val))
                            return;
                        var inrad = val * Math.PI / 180;
                        this.editControl.setRotSnapValue(inrad);
                    };
                    Dk.prototype.isSnapScaleOn = function () {
                        return this.snapScaleOn;
                    };
                    Dk.prototype.setSnapScaleValue = function (val) {
                        if (isNaN(val))
                            return;
                        this.editControl.setScaleSnapValue(val);
                    };
                    Dk.prototype.snapScale = function (yes) {
                        if (this.snapperOn) {
                            return "Cannot change snapping mode when snapper is on";
                        }
                    ...
                    Dk.prototype.snapper = function (yes) {
                    ...
                    Dk.prototype.setSnapperOn = function () {
                        this.editControl.setRotSnap(true);
                        this.editControl.setTransSnap(true);
                        this.editControl.setScaleSnap(true);
                        this.editControl.setRotSnapValue(this.snapRotValue);
                    ...
                    Dk.prototype.setSnapperOff = function () {
                        this.editControl.setRotSnap(false);
                        this.editControl.setTransSnap(false);
                        this.editControl.setScaleSnap(false);
                    };
                    Dk.prototype.isSnapperOn = function () {
                        return this.snapperOn;
                    };
                    Dk.prototype.snapToGlobal = function () {
                        if (this.isMeshSelected) {
                    ...
                    Dk.prototype.getSoundFiles = function () {
                        //TODO implement this.
                        return null;
                        //return <string[]>this.assets["sounds"];
                    };
                    Dk.prototype.anyMeshSelected = function () {
                        return this.isMeshSelected;
                    };
                    Dk.prototype.getName = function () {
                        return this.meshPicked.name;
                    };
                    Dk.prototype.setName = function (name) {
                        this.meshPicked.name = name;
                    };
                    Dk.prototype.getLocation = function () {
                        return this.meshPicked.position;
                    };
                    //Translation
                    Dk.prototype.setLocation = function (valX, valY, valZ) {
                    ...
                    Dk.prototype.setRotation = function (valX, valY, valZ) {
                        if (isNaN(valX) || isNaN(valY) || isNaN(valZ))
                            return;
                        if (this.isMeshSelected) {
                    ...
                    Dk.prototype.setScale = function (valX, valY, valZ) {
                        if (isNaN(valX) || isNaN(valY) || isNaN(valZ))
                            return;
                        if (this.isMeshSelected) {
                    ...
                    Dk.prototype.bakeTransforms = function () {
                    ...
                    Dk.prototype.cloneChangeSkeleton = function (skelId) {
                        var switched = false;
                        var skels = this.scene.skeletons;
                    ...
                    Dk.prototype.toggleSkelView = function () {
                        if (this.meshPicked.skeleton == null)
                            return;
                    ...
                    Dk.prototype.findSkelViewer = function (sva, mesh) {
                    ...
                    Dk.prototype.delSkelViewer = function (sva, sv) {
                        var i = sva.indexOf(sv);
                        if (i >= 0)
                            sva.splice(i, 1);
                    };
                    Dk.prototype.animRest = function () {
                    ...
                    Dk.prototype.createAnimRange = function (name, start, end) {
                    ...
                    Dk.prototype.delAnimRange = function (name, del) {
                        //delete or remove the range
                        this.meshPicked.skeleton.deleteAnimationRange(name, del);
                    };
                    Dk.prototype.getAnimationRanges = function () {
                    ...
                    Dk.prototype.printAnimCount = function (skel) {
                    ...
                    Dk.prototype.playAnimation = function (animName, animRate, loop) {
                        var skel = this.meshPicked.skeleton;
                        if (skel == null)
                            return;
                    ...
                    Dk.prototype.stopAnimation = function () {
                        if (this.meshPicked.skeleton == null)
                            return;
                        this.scene.stopAnimation(this.meshPicked.skeleton);
                    };
                    Dk.prototype.getSensorList = function () {
                        return dk.SNAManager.getSNAManager().getSensorList();
                    };
                    Dk.prototype.getActuatorList = function () {
                        return dk.SNAManager.getSNAManager().getActuatorList();
                    };
                    Dk.prototype.getSensorParms = function (sensor) {
                        return dk.SNAManager.getSNAManager().getSensorParms(sensor);
                    };
                    Dk.prototype.getActuatorParms = function (actuator) {
                        return dk.SNAManager.getSNAManager().getActuatorParms(actuator);
                    };
                    Dk.prototype.getSensors = function () {
                        if (!this.isMeshSelected) {
                            return null;
                        }
                    ...
                    Dk.prototype.getActuators = function () {
                        if (!this.isMeshSelected) {
                            return null;
                        }
                    ...
                    Dk.prototype.addSensorbyName = function (sensName) {
                        if (!this.isMeshSelected) {
                            return null;
                        }
                        return dk.SNAManager.getSNAManager().createSensorByName(sensName, this.meshPicked, null);
                    };
                    Dk.prototype.addActuaorByName = function (actName) {
                        if (!this.isMeshSelected) {
                            return null;
                        }
                        return dk.SNAManager.getSNAManager().createActuatorByName(actName, this.meshPicked, null);
                    };
                    Dk.prototype.add_sensor = function (sensName, prop) {
                        if (!this.isMeshSelected) {
                            return "no mesh selected";
                        }
                        if (sensName === "Touch") {
                            var st = new dk.SensorTouch(this.meshPicked, prop);
                        }
                        else
                            return "No such sensor";
                        return null;
                    };
                    Dk.prototype.addActuator = function (actName, parms) {
                        if (!this.isMeshSelected) {
                            return "no mesh selected";
                        }
                        var act;
                        if (actName === "Rotator") {
                            act = new dk.ActuatorRotator(this.meshPicked, parms);
                        }
                        else if (actName === "Mover") {
                            act = new dk.ActuatorMover(this.meshPicked, parms);
                        }
                        else
                            return "No such actuator";
                        return null;
                    };
                    Dk.prototype.removeSensor = function (index) {
                        if (!this.isMeshSelected) {
                            return "no mesh selected";
                        }
                    ...
                    Dk.prototype.removeActuator = function (index) {
                        if (!this.isMeshSelected) {
                            return "no mesh selected";
                        }
                    ...
                    Dk.prototype.removeSensorActuator = function (sa) {
                        sa.dispose();
                    };
                    Dk.prototype.setSunPos = function (d) {
                    ...
                    Dk.prototype.getSunPos = function () {
                    ...
                    */
                    ...
                    Dk.prototype.getGrndSPSbyID = function (gSpsId) {
                    ...
                    Dk.prototype.createGrndSPS = function () {
                        var gs;
                        if (this.meshesPicked == null) {
                    ...
                    Dk.prototype.getMeshSpreadDtls = function (meshId) {
                        var gs;
                    ...
                    Dk.prototype.updateSPSArray = function (gs) {
                     ...
                     */
                    Dk.prototype.deleteSPS = function (mesh) {
                        if (this.GroundSPSs == null)
                            return;
                        var i = 0;
                        for (var _i = 0, _a = this.GroundSPSs; _i < _a.length; _i++) {
                    ...
                    Dk.prototype.getGrndSPSList = function () {
                        var sl = new Array();
                        if (this.GroundSPSs == null)
                            return sl;
                        for (var _i = 0, _a = this.GroundSPSs; _i < _a.length; _i++) {
                    ...
                    Dk.prototype.spreadOnGround = function () {
                        if (!this.isMeshSelected) {
                            return "no mesh selected";
                        }
                    ...
                    Dk.prototype.toggleDebug = function () {
                     ...
                     * if meant to be used within dk then yes
                     * else no but then we should probably provide an option to save texture too
                     *
                     * for now lets keep as dk based location
                     *
                     */
                    Dk.prototype.saveAsset = function () {
                        if (!this.isMeshSelected) {
                            return null;
                        }
                    ...
                    Dk.prototype.saveAsset_old = function () {
                        if (!this.isMeshSelected) {
                            return null;
                        }
                        //this.renameWorldTextures();
                    ...
                    Dk.prototype.saveWorld = function () {
                        if (this.editControl != null) {
                        ...
                        var dkSerialzed = new dk.DkSerialized();
                        dkSerialzed.settings.cameraCollision = this._cameraCollision;
                        dkSerialzed.settings.autoEditMenu = this.autoEditMenu;
                        dkSerialzed.guiSettings = this.dkGUI.getSettings();
                        dkSerialzed.misc.activeCameraTarget = this.mainCamera.target;
                        ...
                        //is loaded in future
                        if (this.GroundSPSs != null) {
                            dkSerialzed.groundSPSserializeds = new Array();
                            for (var _i = 0, _a = this.GroundSPSs; _i < _a.length; _i++) {
                                var gSPS = _a[_i];
                                console.log("saving");
                                console.log(gSPS);
                                dkSerialzed.groundSPSserializeds.push(gSPS.serialize());
                            }
                        }
                    ...
                    Dk.prototype.addInstancesToShadow = function () {
                        for (var _i = 0, _a = this.scene.meshes; _i < _a.length; _i++) {
                            var mesh = _a[_i];
                            if (mesh != null && mesh instanceof BABYLON.InstancedMesh) {
                                //TODO think
                     ...
                     *
                     */
                    Dk.prototype.renameMeshIds = function () {
                        var i = 0;
                        for (var _i = 0, _a = this.scene.meshes; _i < _a.length; _i++) {
                            var mesh = _a[_i];
                     ...
                     * @param scene
                     */
                    Dk.prototype.resetSkels = function (scene) {
                        var i = 0;
                    ...
                    Dk.prototype.renameWorldTextures = function () {
                    ...
                    Dk.prototype.renameWorldMaterials = function (mats) {
                        var sm;
                    ...
                    Dk.prototype.rename = function (bt) {
                        if (bt == null)
                            return;
                     ...
                     *
                     */
                    Dk.prototype.changeSoundUrl = function (sceneObj) {
                     ...
                     */
                    Dk.prototype.removeSounds = function (sceneObj) {
                        var sounds = sceneObj["sounds"];
                        if (sounds != null) {
                            sceneObj["sounds"] = [];
                        }
                     ...
                     */
                    Dk.prototype.cleanupMats = function () {
                        var meshes = this.scene.meshes;
                        var mats = new Array();
                        var mms = new Array();
                     ...
                     *
                     */
                    Dk.prototype.cleanupSkels = function () {
                        var meshes = this.scene.meshes;
                        var skels = new Array();
                    ...
                    Dk.prototype.loadAssetFile = function (file) {
                        var _this = this;
                        var sceneFolderName = file.name.split(".")[0];
                        SceneLoader.ImportMesh("", "dk/assets/" + sceneFolderName + "/", file.name, this.scene, function (meshes, particleSystems, skeletons) { return _this.onMeshLoaded(meshes, particleSystems, skeletons); });
                    };
                    Dk.prototype.loadAsset = function (assetType, file) {
                        var _this = this;
                        this.filePath = assetType;
                        this.file = file;
                        var fileName = file.split(".")[0];
                        SceneLoader.ImportMesh("", "dk/assets/" + assetType + "/" + fileName + "/", file, this.scene, function (meshes, particleSystems, skeletons) { return _this.onMeshLoaded(meshes, particleSystems, skeletons); });
                    };
                    Dk.prototype.loadAsset2 = function (path, file) {
                        var _this = this;
                        this.filePath = path;
                        this.file = file;
                        SceneLoader.ImportMesh("", "dk/" + path, file, this.scene, function (meshes, particleSystems, skeletons) { return _this.onMeshLoaded(meshes, particleSystems, skeletons); });
                    };
                     ...
                     */
                    Dk.prototype.onMeshLoaded = function (meshes, particleSystems, skeletons) {
                    ...
                    Dk.prototype._postLoad = function (meshes) {
                     ...
                     *
                     */
                    Dk.prototype._makeMatIdUnique = function (msh) {
                        var mesh = msh;
                        if (mesh.material != null) {
                    ...
                    Dk.prototype._renameTextures = function (mesh) {
                        if (mesh.material != null) {
                            if (mesh.material instanceof BABYLON.MultiMaterial) {
                                var mm = mesh.material;
                                var mats = mm.subMaterials;
                    ...
                    Dk.prototype.renameAssetTextures = function (sm) {
                    ...
                    Dk.prototype.renameAssetTexture = function (bt) {
                        if (bt == null)
                            return;
                        var textureName = bt.name;
                        console.log("renaming " + textureName);
                        if (textureName.indexOf("dk/") !== 0 && textureName.indexOf("../") !== 0) {
                            //bt.name="dk/assets/"+this.filePath+"/"+this.file.split(".")[0]+"/"+textureName;
                            bt.name = bt.url;
                        }
                    };
                    /**
                     ...
                     * @return
                     */
                    Dk.prototype.getBoundingRadius = function (meshes) {
                        var maxRadius = 0;
                    ...
                    Dk.prototype.loadWorldFile = function (file) {
                        var _this = this;
                    ...
                    Dk.prototype.onSceneFileRead = function (e) {
                        var _this = this;
                    ...
                    Dk.prototype.onSceneDispose = function () {
                        var _this = this;
                        this.scene = null;
                    ...
                    Dk.prototype.createWater = function () {
                    ...
                    Dk.prototype.addWater = function () {
                        if (!this.isMeshSelected) {
                            return "no mesh selected";
                        }
                        var water = new WaterMaterial("water", this.scene);
                    ...
                    Dk.prototype.switchAvatar = function () {
                        if (!this.isMeshSelected) {
                            return "no mesh selected";
                        }
                        if (this.isAvatar(this.meshPicked)) {
                            this.cc.stop();
                            //old avatar
                            dk.SNAManager.getSNAManager().enableSnAs(this.avatar);
                            ...
                            Tags.RemoveTagsFrom(this.avatar, "Dk.avatar");
                            if (this.avatarSkeleton != null) {
                                Tags.RemoveTagsFrom(this.avatarSkeleton, "Dk.skeleton");
                                this.avatarSkeleton.name = "";
                            }
                            //new avatar
                            this.avatar = this.meshPicked;
                            this.avatarSkeleton = this.avatar.skeleton;
                            Tags.AddTagsTo(this.avatar, "Dk.avatar");
                            if (this.avatarSkeleton != null) {
                                Tags.AddTagsTo(this.avatarSkeleton, "Dk.skeleton");
                                this.avatarSkeleton.name = "Dk.skeleton";
                                this.avatarSkeleton.enableBlending(this._animBlend);
                            }
                            ...
                            this.isFocusOnAv = true;
                            this.removeEditControl();
                            dk.SNAManager.getSNAManager().disableSnAs(this.avatar);
                    ...
                    Dk.prototype.isAvatar = function (mesh) {
                        if (mesh.skeleton == null) {
                            return false;
                        }
                        return true;
                    };
                    Dk.prototype.createGround = function (scene) {
                    ...
                    Dk.prototype.createGround_htmap = function (scene) {
                        var _this = this;
                    ...
                    Dk.prototype.createGroundMaterial = function (scene) {
                        var groundMaterial = new StandardMaterial("groundMat", scene);
                        groundMaterial.diffuseTexture = new Texture(this.groundTexture, scene);
                        groundMaterial.bumpTexture = new Texture(this.groundBumpTexture, scene);
                    ...
                    Dk.prototype.onDataMapReady = function (map, subX, subZ) {
                        ...
                        Tags.AddTagsTo(this.ground, "Dk.ground Dk.internal");
                    };
                    Dk.prototype.creatDynamicTerrain = function () {
                        var _this = this;
                        var dmOptions = {
                            width: 1024,
                            height: 1024,
                    ...
                    Dk.prototype.createSkyBox = function (scene) {
                        ...
                        Tags.AddTagsTo(skybox, "Dk.sky Dk.internal");
                        return skybox;
                    };
                    Dk.prototype.toggleSnow = function () {
                    ...
                    Dk.prototype.toggleRain = function () {
                     ...
                     */
                    Dk.prototype.createSnowPart = function () {
                     ...
                     */
                    Dk.prototype.createRainPart = function () {
                    ...
                    Dk.prototype.createParticles = function (partId) {
                        if (this.meshPicked == null) {
                            return "no mesh selected";
                        }
                        var part = null;
                    ...
                    Dk.prototype._createFirePart = function () {
                        // Create a particle system
                        var fireSystem = new BABYLON.ParticleSystem("particles", 2000, this.scene);
                        //Texture of each particle
                        fireSystem.particleTexture = new BABYLON.Texture("dk/internal/assets/particles/fire/flare.png", this.scene);
                    ...
                    Dk.prototype._createSmokePart = function () {
                        var smokeSystem = new BABYLON.ParticleSystem("particles", 1000, this.scene);
                        smokeSystem.particleTexture = new BABYLON.Texture("dk/internal/assets/particles/smoke/flare.png", this.scene);
                    ...
                    Dk.prototype.createCamera = function (scene, canvas) {
                        ...
                        Tags.AddTagsTo(camera, "Dk.camera");
                        return camera;
                    };
                    Dk.prototype.createAvatar = function () {
                        var _this = this;
                    ...
                    Dk.prototype.onAvatarLoaded = function (meshes, particleSystems, skeletons) {
                    ...
                    Dk.prototype.setCharacterController = function (cc) {
                     ...
                     * @param skel
                     */
                    Dk.prototype.fixAnimationRanges = function (skel) {
                        var ranges = skel.getAnimationRanges();
                    ...
                    Dk.prototype.setCameraSettings = function (camera) {
                    ...
                    Dk.prototype.backfaceCulling = function (mat) {
                        var index;
                        for (index = 0; index < mat.length; ++index) {
                            mat[index].backFaceCulling = false;
                        }
                    };
                    Dk.prototype.disableKeys = function () {
                        this.keysDisabled = true;
                        this.cc.stop();
                    };
                    Dk.prototype.enableKeys = function () {
                        this.keysDisabled = false;
                        if (this.isFocusOnAv)
                            this.cc.start();
                    };
                    Dk.prototype.enableCameraCollision = function (yesNo) {
                        this._cameraCollision = yesNo;
                        this.mainCamera.checkCollisions = yesNo;
                        this.cc.cameraCollisionChanged();
                    };
                    Dk.prototype.isCameraCollisionOn = function () {
                        return this._cameraCollision;
                    };
                    Dk.prototype.enableAutoEditMenu = function (yesNo) {
                        this.autoEditMenu = yesNo;
                    };
                    Dk.prototype.isAutoEditMenuOn = function () {
...
(function (org) {
    ...
    (function (sg) {
        ...
        (function (babylonjs) {
            ...
            (function (dk) {
                var Vector3 = BABYLON.Vector3;
                var DkSerialized = (function () {
                    function DkSerialized() {
                        this.settings = new SettingsSerialized();
                        this.misc = new MiscSerialized();
                    }
                    return DkSerialized;
                }());
                dk.DkSerialized = DkSerialized;
                ...
                dk.SettingsSerialized = SettingsSerialized;
                /*
                ...
                dk.MiscSerialized = MiscSerialized;
            })(dk = babylonjs.dk || (babylonjs.dk = {}));
        })(babylonjs = sg.babylonjs || (sg.babylonjs = {}));
    })(sg = org.sg || (org.sg = {}));
})(org || (org = {}));
    ...
    (function (sg) {
        ...
        (function (babylonjs) {
            ...
            (function (dk) {
                ...
                var Vector3 = BABYLON.Vector3;
                var Vector2 = BABYLON.Vector2;
                var FileInputType = org.sg.babylonjs.dk.gui.FileInputType;
                var Range = org.sg.babylonjs.dk.gui.Range;
                var SelectType = org.sg.babylonjs.dk.gui.SelectType;
                var SNAManager = (function () {
                    ...
                    SNAManager.prototype.unMarshal = function (snas, scene) {
                        ...
                        for (var _a = 0, renames_1 = renames; _a < renames_1.length; _a++) {
                            ...
                            mesh_1.name = mesh_1.name.split(".Dk.uid.")[0];
                        }
                    };
                    /**
                     ...
                     * As such we would append the new dk.uid to the name during save.
                     * When de-serializing, during load, we will remove the dk.uid from name.
                     * see unmarhsall() also.
                     *
                     * TODO:check if we can use this method for all meshes rather than just InstancedMesh
                     */
                    SNAManager.prototype.getMeshDkUid = function (mesh) {
                        if (!(mesh instanceof BABYLON.InstancedMesh) && (Tags.HasTags(mesh))) {
                            var tags = Tags.GetTags(mesh, true).split(" ");
                            for (var _i = 0, tags_1 = tags; _i < tags_1.length; _i++) {
                                var tag = tags_1[_i];
                                var i = tag.indexOf("Dk.uid.");
                                if (i >= 0)
                                    return tag;
                            }
                        }
                        var uid;
                        uid = "Dk.uid." + new Number(Date.now()).toString();
                    ...
                    SNAManager.prototype.getCamera = function () {
                        return dk.Dk.dk.mainCamera;
                    };
                    return SNAManager;
                }());
                dk.SNAManager = SNAManager;
                var SNAserialized = (function () {
                    function SNAserialized() {
                    }
                    return SNAserialized;
                }());
                dk.SNAserialized = SNAserialized;
                ...
                dk.SensorAbstract = SensorAbstract;
                ...
                dk.ActuatorAbstract = ActuatorAbstract;
                ...
                dk.SNAproperties = SNAproperties;
                ...
                dk.ActProperties = ActProperties;
            })(dk = babylonjs.dk || (babylonjs.dk = {}));
        })(babylonjs = sg.babylonjs || (sg.babylonjs = {}));
    })(sg = org.sg || (org.sg = {}));
})(org || (org = {}));
    ...
    (function (sg) {
        ...
        (function (babylonjs) {
            ...
            (function (dk) {
                ...
                dk.ActuatorAnimator = ActuatorAnimator;
            })(dk = babylonjs.dk || (babylonjs.dk = {}));
        })(babylonjs = sg.babylonjs || (sg.babylonjs = {}));
    })(sg = org.sg || (org.sg = {}));
})(org || (org = {}));
org.sg.babylonjs.dk.SNAManager.getSNAManager().addActuator("Animator", org.sg.babylonjs.dk.ActuatorAnimator);
var org;
(function (org) {
    var sg;
    (function (sg) {
        ...
        (function (babylonjs) {
            ...
            (function (dk) {
                ...
                dk.AvAnimatorProp = AvAnimatorProp;
                /**
                ...
                var ActuatorAvAnimator = (function (_super) {
                    ...
                    function ActuatorAvAnimator(mesh, parms) {
                        ...
                        var avMesh = scene.getMeshesByTags("Dk.avatar")[0];
                    ...
                    ActuatorAvAnimator.prototype.actuate = function () {
                        ...
                        var prop = this.properties;
                        this.avMesh = dk.SNAManager.getSNAManager().getAV();
                        var skel = this.avMesh.skeleton;
                        if (skel != null) {
                            dk.SNAManager.getSNAManager().disableAV();
                            ...
                            if (prop.focusOnAV) {
                                var camera = dk.SNAManager.getSNAManager().getCamera();
                    ...
                    ActuatorAvAnimator.prototype.stop = function () {
                        ...
                        dk.SNAManager.getSNAManager().enableAV();
                ...
                dk.ActuatorAvAnimator = ActuatorAvAnimator;
            })(dk = babylonjs.dk || (babylonjs.dk = {}));
        })(babylonjs = sg.babylonjs || (sg.babylonjs = {}));
    })(sg = org.sg || (org.sg = {}));
})(org || (org = {}));
org.sg.babylonjs.dk.SNAManager.getSNAManager().addActuator("AvAnimator", org.sg.babylonjs.dk.ActuatorAvAnimator);
var org;
(function (org) {
    var sg;
    (function (sg) {
        ...
        (function (babylonjs) {
            ...
            (function (dk) {
                ...
                dk.ActCloakerProp = ActCloakerProp;
                ...
                dk.ActuatorCloaker = ActuatorCloaker;
            })(dk = babylonjs.dk || (babylonjs.dk = {}));
        })(babylonjs = sg.babylonjs || (sg.babylonjs = {}));
    })(sg = org.sg || (org.sg = {}));
})(org || (org = {}));
org.sg.babylonjs.dk.SNAManager.getSNAManager().addActuator("Cloaker", org.sg.babylonjs.dk.ActuatorCloaker);
var org;
(function (org) {
    var sg;
    (function (sg) {
        ...
        (function (babylonjs) {
            ...
            (function (dk) {
                ...
                dk.ActDisablerProp = ActDisablerProp;
                ...
                dk.ActuatorDisabler = ActuatorDisabler;
            })(dk = babylonjs.dk || (babylonjs.dk = {}));
        })(babylonjs = sg.babylonjs || (sg.babylonjs = {}));
    })(sg = org.sg || (org.sg = {}));
})(org || (org = {}));
org.sg.babylonjs.dk.SNAManager.getSNAManager().addActuator("Disabler", org.sg.babylonjs.dk.ActuatorDisabler);
var org;
(function (org) {
    var sg;
    (function (sg) {
        ...
        (function (babylonjs) {
            ...
            (function (dk) {
                ...
                dk.ActEnablerProp = ActEnablerProp;
                ...
                dk.ActuatorEnabler = ActuatorEnabler;
            })(dk = babylonjs.dk || (babylonjs.dk = {}));
        })(babylonjs = sg.babylonjs || (sg.babylonjs = {}));
    })(sg = org.sg || (org.sg = {}));
})(org || (org = {}));
org.sg.babylonjs.dk.SNAManager.getSNAManager().addActuator("Enabler", org.sg.babylonjs.dk.ActuatorEnabler);
/**
    ...
    (function (sg) {
        ...
        (function (babylonjs) {
            ...
            (function (dk) {
                ...
                dk.ActuatorLight = ActuatorLight;
            })(dk = babylonjs.dk || (babylonjs.dk = {}));
        })(babylonjs = sg.babylonjs || (sg.babylonjs = {}));
    })(sg = org.sg || (org.sg = {}));
})(org || (org = {}));
org.sg.babylonjs.dk.SNAManager.getSNAManager().addActuator("Light", org.sg.babylonjs.dk.ActuatorLight);
var org;
(function (org) {
    var sg;
    (function (sg) {
        ...
        (function (babylonjs) {
            ...
            (function (dk) {
                ...
                dk.ActuatorMover = ActuatorMover;
            })(dk = babylonjs.dk || (babylonjs.dk = {}));
        })(babylonjs = sg.babylonjs || (sg.babylonjs = {}));
    })(sg = org.sg || (org.sg = {}));
})(org || (org = {}));
org.sg.babylonjs.dk.SNAManager.getSNAManager().addActuator("Mover", org.sg.babylonjs.dk.ActuatorMover);
var org;
(function (org) {
    var sg;
    (function (sg) {
        ...
        (function (babylonjs) {
            ...
            (function (dk) {
                ...
                dk.ActRotatorParm = ActRotatorParm;
                ...
                dk.ActuatorRotator = ActuatorRotator;
            })(dk = babylonjs.dk || (babylonjs.dk = {}));
        })(babylonjs = sg.babylonjs || (sg.babylonjs = {}));
    })(sg = org.sg || (org.sg = {}));
})(org || (org = {}));
org.sg.babylonjs.dk.SNAManager.getSNAManager().addActuator("Rotator", org.sg.babylonjs.dk.ActuatorRotator);
var org;
(function (org) {
    var sg;
    (function (sg) {
        ...
        (function (babylonjs) {
            ...
            (function (dk) {
                ...
                dk.ActuatorSound = ActuatorSound;
            })(dk = babylonjs.dk || (babylonjs.dk = {}));
        })(babylonjs = sg.babylonjs || (sg.babylonjs = {}));
    })(sg = org.sg || (org.sg = {}));
})(org || (org = {}));
org.sg.babylonjs.dk.SNAManager.getSNAManager().addActuator("Sound", org.sg.babylonjs.dk.ActuatorSound);
var org;
(function (org) {
    var sg;
    (function (sg) {
        ...
        (function (babylonjs) {
            ...
            (function (dk) {
                ...
                dk.SensorClick = SensorClick;
            })(dk = babylonjs.dk || (babylonjs.dk = {}));
        })(babylonjs = sg.babylonjs || (sg.babylonjs = {}));
    })(sg = org.sg || (org.sg = {}));
})(org || (org = {}));
org.sg.babylonjs.dk.SNAManager.getSNAManager().addSensor("Click", org.sg.babylonjs.dk.SensorClick);
var org;
(function (org) {
    var sg;
    (function (sg) {
        ...
        (function (babylonjs) {
            ...
            (function (dk) {
                ...
                dk.SenContactProp = SenContactProp;
                var SensorContact = (function (_super) {
                    ...
                    SensorContact.prototype.onPropertiesChange = function () {
                        ...
                        var otherMesh = scene.getMeshesByTags("Dk.avatar")[0];
                ...
                dk.SensorContact = SensorContact;
            })(dk = babylonjs.dk || (babylonjs.dk = {}));
        })(babylonjs = sg.babylonjs || (sg.babylonjs = {}));
    })(sg = org.sg || (org.sg = {}));
})(org || (org = {}));
org.sg.babylonjs.dk.SNAManager.getSNAManager().addSensor("Contact", org.sg.babylonjs.dk.SensorContact);
var org;
(function (org) {
    var sg;
    (function (sg) {
        ...
        (function (babylonjs) {
            ...
            (function (dk) {
                ...
                dk.SensorTimer = SensorTimer;
            })(dk = babylonjs.dk || (babylonjs.dk = {}));
        })(babylonjs = sg.babylonjs || (sg.babylonjs = {}));
    })(sg = org.sg || (org.sg = {}));
})(org || (org = {}));
org.sg.babylonjs.dk.SNAManager.getSNAManager().addSensor("Timer", org.sg.babylonjs.dk.SensorTimer);
var org;
(function (org) {
    var sg;
    (function (sg) {
        ...
        (function (babylonjs) {
            ...
            (function (dk) {
                ...
                dk.SensorTouch = SensorTouch;
            })(dk = babylonjs.dk || (babylonjs.dk = {}));
        })(babylonjs = sg.babylonjs || (sg.babylonjs = {}));
    })(sg = org.sg || (org.sg = {}));
})(org || (org = {}));
org.sg.babylonjs.dk.SNAManager.getSNAManager().addSensor("Touch", org.sg.babylonjs.dk.SensorTouch);
